...
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{back.jpg}}
...
\begin{frame}
	\frametitle{\insertsection}
	\begin{itemize}
		\item[\textbullet] На слайдах отображаетя материал, набранный изначально в \LaTeX'е. 
		\item[\textbullet] На слайдах много формул.
		\item[\textbullet] Вам не хочется думать о переносимости файлов PowerPoint между различными версиями / компьютерами. Готовый файл pdf отображается везде. 
	\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{\insertsection}
	\begin{itemize}
		\item[\textbullet] Beamer - класс для \LaTeX'а,специально предназначенный для создания презентаций.
